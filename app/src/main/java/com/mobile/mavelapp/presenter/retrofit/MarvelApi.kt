...
interface MarvelApi {
    ...
    fun getHeroDetailStories(@Path("characterId") id: String, @Query("ts") ts: String, @Query("apikey") apikey: String, @Query("hash") hash: String): Observable<DetailDataResponse>
